...
function criarGrafico(id, tipo, labels, dados, cores) {
    ...
    charts[id] = new Chart(ctx, {
        type: tipo,
        data: { labels: labels, datasets: [{ label: '', data: dados, backgroundColor: cores, borderColor: 'rgba(0,0,0,0.1)', borderWidth: 1 }] },
...
function atualizarDashboard() {
    ...
    criarGrafico('areaAplicacaoChart','bar',['Prédio GAD','Prédio PCI/Utilidades'],[28.2,9.44],['#0b63d6','#f59e0b']);
